            ...
            <div class="sharedropdown">
                ...
                <div id="shareDropdown" class="sharedropdown-content">
                    <div class="icons d-flex justify-content-between">
                        ...
                        <div class="share-icon border-gradient border-gradient-orange me-2  d-flex justify-content-center align-items-center"
                             target="_blank">
                            <a href="http://www.linkedin.com/shareArticle?mini=true&url={{$shareUrl}}"><i
                        ...
                        <div class="share-icon border-gradient border-gradient-orange me-2  d-flex justify-content-center align-items-center">
                            <a href="http://pinterest.com/pin/create/link/?url={{$shareUrl}}"><i
                                        class="fa-brands fa-pinterest-p d-flex justify-content-center align-items-center"
                                        target="_blank"></i></a>
                        </div>
                        <div class="share-icon border-gradient border-gradient-orange me-2  d-flex justify-content-center align-items-center">
                        ...
                        <div class="share-icon border-gradient border-gradient-orange me-2  d-flex justify-content-center align-items-center">
                            <a href="https://wa.me/?text={{$shareUrl}}"><i
